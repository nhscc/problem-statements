...
> Note: flights are generated by the system up to 30 days in advance. There will
be no flights that exist more than 30 days in the future.

> Warning: flights with status "past" will be deleted from the API after 30
