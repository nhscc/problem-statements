...
elapsed since January 1, 1970 00:00:00 UTC. This includes arrive and departure
...
> Note: flights are generated by the system up to 90 days in advance. There will
be no flights that exist more than 90 days in the future.

> Warning: flights with status "past" will be deleted from the API after 90
...
originally. Only accessing your local database (and/or generating up your own
...
> the user remember anything other than their name and password**. Be careful.
...
**Your app must cross-check flyer information against No Fly List when booking a
ticket.**
...
> return an `HTTP 555` error to your app instead of fulfilling a request. During
