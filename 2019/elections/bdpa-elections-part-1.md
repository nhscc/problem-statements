...
- A globally unique identifier
  **([generated by the API](https://hscc4cfe8be7.docs.apiary.io), cannot be
  modified)**
- A title
- A description
...
be stored using the API. Hence, some election data will be split between
[the elections API](https://hscc4cfe8be7.docs.apiary.io) and your own local
